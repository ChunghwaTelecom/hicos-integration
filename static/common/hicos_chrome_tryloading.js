...
if (bowser.name == 'Chrome' && bowser.version > 45) {
    ...
    function downloadJSAtOnload() {	
        ...
        var handler = setInterval(checkForExtJS_complete, 300);

        function checkForExtJS_complete() {
		
			if (retry >= MAX_RETRY) {
				
				console.log("stop for loading HiCOS Chrome extension because of retry limit.");
            ...
            console.log("try to loading HiCOS Chrome extension.");
